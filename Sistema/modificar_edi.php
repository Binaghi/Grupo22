...
<div class="contenedor">
	<div class="login-box">
		...
		<form method = "post" action = "actionModificarEditorial.php">
		<div class="login-box-name"><b>Nombre:</b></div>
		<div class="login-box-field">
			<input type="text" name="mod" id="mod" size="30" maxlength="20">	
			<b>ID-Editorial</b><input type="text" name="modificado" value=<?php echo $borrar ?>>
		</div>
		<div class= "boton">
