...
$(function() {
    $("#formid").validate({
        ...
        messages: {
            mod: "Introducir Nombre de Editorial!!",
        },
    });
}); 
</script>   
	  ...
	  <div class="encabezado">
		...
		<div class="principal">
	      ...
	      <div class="modificar">
	          	...
	          	<H2>(Datos a modificar: <?php echo $nom?>)</H2>
		        <form id="formid" method = "post" action = "actionModificarEditorial.php">
					<p><b>Nombre:</b><input type="text" name="mod" id="mod" size="30" maxlength="20"></p>	
